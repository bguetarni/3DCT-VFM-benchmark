...
start cmd /k "python experiments.py --pretraining cox+protonet --task %TASK% --output %OUTPUT% --dataset %DATASET% --epoch %EPOCHS% --kfold %KFOLD% --modality image --extractors ct-fm --backbone ffn --normalizer scale --lr %LR% --lr_scheduler  --bsize %BISZE% --undersampling --gpu 3"
...
start cmd /k "python experiments.py --pretraining cox+protonet --task %TASK% --output %OUTPUT% --dataset %DATASET% --epoch %EPOCHS% --kfold %KFOLD% --modality both --extractors ct-fm --backbone concat --normalizer scale --lr %LR% --lr_scheduler  --bsize %BISZE% --undersampling --gpu 3"
start cmd /k "python experiments.py --pretraining cox+protonet --task %TASK% --output %OUTPUT% --dataset %DATASET% --epoch %EPOCHS% --kfold %KFOLD% --modality both --extractors ct-fm --backbone attention --normalizer scale --lr %LR% --lr_scheduler  --bsize %BISZE% --undersampling --gpu 3"
start cmd /k "python experiments.py --pretraining cox+protonet --task %TASK% --output %OUTPUT% --dataset %DATASET% --epoch %EPOCHS% --kfold %KFOLD% --modality both --extractors ct-fm --backbone gated --normalizer scale --lr %LR% --lr_scheduler  --bsize %BISZE% --undersampling --gpu 3"
